...
SSPilot is an innovative application designed to optimize and accelerate your online casino gaming experience, particularly on the **Stake** platform.
...
- [⚙️ Secondary Features](#%EF%B8%8F-secondary-features)
- [🎰 Supported Providers](#-supported-providers)
- [🎲 Original Games](#-original-games)
- [🛠️ Installation](#%EF%B8%8F-installation)
- [📚 Quick Start Guide](#-quick-start-guide)
  - [Initial Configuration](#initial-configuration)
  - [Using the Code Claimer](#using-the-code-claimer)
...
- **🎰 Spin slots without interface**: Enjoy a faster gaming experience by eliminating unnecessary graphical interfaces.
- **🎲 Ultra-fast spins on original games**: Increase efficiency with reduced spin times.
- **🏹 Automatic bonus hunts**: Perform bonus hunts effortlessly with full automation.

### ⚙️ Secondary Features

- **📊 Statistics export**: Analyze your performance by exporting your game data.
- **📸 Quick screenshot**: Instantly capture screenshots of your sessions.
- **🔔 Telegram notifications**: Receive real-time updates directly on Telegram.
- **💾 Automatic settings backup**: Keep your preferences without manual action.
- **🎰 Bonus selection for certain slots**: Choose the bonus that best fits your strategy.
- **🃏 Gamble feature (for some providers)**: Try to multiply your winnings with the Gamble feature.
- **👥 Multiple instances management**: Run multiple sessions of the application simultaneously.
- **💬 Auto-post on Chat Challenge**: Automatically participate in chat challenges.
- **🛑 Stop on Loss**: Limit your losses by setting stop thresholds.
- **💰 Automatic vault deposit on profit**: Protect your gains by automatically transferring them to the vault.
- **📈 Multipliers list**: Track obtained multipliers in real-time.
- **🖥️ Intuitive and customizable user interface**: Adapt the application to your needs.
- **🔄 Automatic updates**: Enjoy the latest improvements without manual intervention.
- **🎁 Automatic Bonus Code Claimer**: Claim your bonus codes effortlessly.
...
1. **Download**: Get the `.exe` file of the latest version of SSPilot from our [GitHub releases page](https://github.com/McSon2/SSP/releases/latest).
2. **Installation**: Run the downloaded `.exe` file and follow the on-screen instructions.

> **Note**: Always use the latest version to benefit from the most recent features and fixes.

### 📚 Quick Start Guide

#### Initial Configuration

- **Login**: Connect to your **Stake** account directly via the application.
- **Settings**: Access settings to customize your experience according to your preferences.

#### Using the Code Claimer

1. Click on **"Claimer"** in the main interface.
2. Log in to **Stake** (required only on first use).
3. Leave the window open to allow automatic bonus code claiming.

#### Telegram Notifications

1. Go to the Telegram bot: [t.me/sspilot_bot](https://t.me/sspilot_bot)
2. Send the `/start` command to initiate the conversation.
3. Enter the code displayed in the application's spins interface to link your account.

### 🆙 Updates

SSPilot is regularly enhanced with new features and optimizations. Check out our [changelog](https://github.com/McSon2/SSP/releases/latest) to discover the latest updates.

### 🤝 Support

For any assistance or questions:

- **Discord**: Join our [community server](https://discord.gg/fKQJw8Bcaz) to interact with other users and the development team.
